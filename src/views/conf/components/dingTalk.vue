        ...
        <span style="color: #909399; margin-left: 10px">
          ...
          >
            <div style="font-size: 14px; padding: 1px; line-height: 30px; color: #606266; font-weight: 550">
              ...
              <div>3. 右侧开关可以控制本项目是否启用钉钉机器人通知</div>
              <div>4. 如何配置钉钉机器人请查看 <a href="https://www.baidu.com" target="_blank" style="color: #409EFF">教程文档</a></div>
            </div>
...
export default {
  ...
  methods: {
    ...
    removeToken(index) {
      ...
      } else this.$message.error('消息令牌最少为 1')
    },
